  ...
  const mockLogs = [
    {
      ...
      description: 'Advanced AI phishing attack blocked by detection system with 94% confidence',
      timestamp: new Date().toISOString(),
      metadata: JSON.stringify({ source: 'threat_detection', confidence: 0.94, attack_type: 'ai_phishing' })
    },
    {
      id: '2',
      level: 'warning',
